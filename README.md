...
A simple Wordpress plugin that limits the image upload size.
...
To install copy files from `src/` directory to new `wp-content/plugins/upload-max-image-size` directory of your site.
